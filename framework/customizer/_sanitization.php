...
function dellow_sanitize_checkbox( $input ) {
    if ( $input == 1 ) {
        return 1;
    } else {
        return '';
...
function dellow_sanitize_positive_number( $input ) {
...
function dellow_sanitize_category( $input ) {
...
function dellow_sanitize_product_category( $input ) {
