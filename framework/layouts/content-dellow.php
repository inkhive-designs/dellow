...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-12 col-sm-12 dellow'); ?>>
    ...
    <?php endif; ?>
        ...
        <div class="out-thumb <?php echo $class; ?>">
            ...
            <div class="postedon"><?php dellow_posted_on_icon('both'); ?></div>
            <span class="entry-excerpt"><?php echo substr(get_the_excerpt(),0,400); ?></span>
            <span class="readmore"><a href="<?php the_permalink() ?>"><?php esc_html_e('Continue Reading','dellow'); ?> &rarr;</a></span>
        </div>
